...
const isBookInCategory = (book, bookShelf) => {
    return (
        ...
        bookShelf.currentlyReading.some((b) => b.google_books_id === book.google_book_id) ||
        bookShelf.wishToRead.some((b) => b.google_books_id === book.google_book_id)
    );
};

const AddBookToBookshelf = ({ category, onBookAdded, bookShelf, closeModal }) => {
    ...
    const handleSearchChange = (e) => {
        ...
        debouncedFetchSearchResults(e.target.value, setLoading, setError, setSearchResults);
    };
    ...
    const handleAddBook = async (book) => {
        if (isBookInCategory(book, bookShelf)) {
            ...
            console.log("Error set: This book is already in your library with the same status.");
            closeModal();
            return;
        }
        ...
        try {
            ...
            if (err.response && err.response.data.error) {
                ...
                if (err.response.data.error === "Book already exists in user's library") {
                    setError("This book is already in your library under a different status.");
                } else {
