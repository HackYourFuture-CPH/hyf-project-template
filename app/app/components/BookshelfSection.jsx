    ...
    return (
        <div className={styles.bookshelfSection}>
            ...
            <div className={styles.bookshelfImages}>
                ...
                <Button className={styles.addBookButton} onClick={() => onAddBookClick(category)}>
                    ADD BOOK
                </Button>
            </div>
            ...
            {hasMoreBooks && (
                <div className={styles.seeMoreContainer}>
                    {!showAll ? (
                        ...
                        >
                            <img src="more.png" alt="See More" className={styles.buttonIcon} />
                        </button>
                    ) : (
                        <button
                        ...
                        >
                            <img src="more.png" alt="See Less" className={styles.buttonIcon} />
                        </button>
                    )}
                </div>
            )}
